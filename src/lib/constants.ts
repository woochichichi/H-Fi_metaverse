...
export type PetType =
  ...
  | 'unicorn' | 'panda' | 'duck'
  | 'crab' | 'butterfly'
  | 'tiger' | 'rat' | 'ox' | 'horse' | 'sheep'
  | 'monkey' | 'rooster' | 'pig';

export const PETS: { id: PetType; label: string; emoji: string }[] = [
  { id: 'none',      label: '없음',     emoji: '❌' },
  // ── 12간지 ──
  { id: 'rat',       label: '쥐(자)',    emoji: '🐭' },
  { id: 'ox',        label: '소(축)',    emoji: '🐮' },
  { id: 'tiger',     label: '호랑이(인)', emoji: '🐯' },
  { id: 'rabbit',    label: '토끼(묘)',  emoji: '🐰' },
  { id: 'dragon',    label: '용(진)',    emoji: '🐉' },
  { id: 'snake',     label: '뱀(사)',    emoji: '🐍' },
  { id: 'horse',     label: '말(오)',    emoji: '🐴' },
  { id: 'sheep',     label: '양(미)',    emoji: '🐑' },
  { id: 'monkey',    label: '원숭이(신)', emoji: '🐵' },
  { id: 'rooster',   label: '닭(유)',    emoji: '🐔' },
  { id: 'dog',       label: '강아지(술)', emoji: '🐶' },
  { id: 'pig',       label: '돼지(해)',  emoji: '🐷' },
  // ── 기타 ──
...
export const ROOMS_DATA: Record<RoomId, RoomDef> = {
  stock: {
    ...
    zones: [
      ...
      // { id: 'stock-kpi', team: '증권ITO', label: '📊 KPI', emoji: '📊', x: 640, y: 60, width: 500, height: 340 },  // KPI 임시 숨김
  ...
  life: {
    ...
    zones: [
      ...
      // { id: 'life-kpi', team: '생명ITO', label: '📊 KPI', emoji: '📊', x: 640, y: 60, width: 500, height: 340 },  // KPI 임시 숨김
  ...
  shield: {
    ...
    zones: [
      ...
      // { id: 'shield-kpi', team: '손보ITO', label: '📊 KPI', emoji: '📊', x: 640, y: 60, width: 500, height: 340 },  // KPI 임시 숨김
