  ...
  return (
    <div className="relative flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-white/[.06] px-4 py-3">
        <h2 className="font-heading text-base font-bold text-text-primary">📋 공지</h2>
      ...
      <div className="border-b border-white/[.06] bg-accent/[.04] px-4 py-2">
        <p className="text-[11px] leading-relaxed text-text-muted">
          <span className="font-semibold text-text-secondary">팀 전체가 알아야 할 소식이에요</span> — 긴급·할일·참고 시급성별로 확인하세요. 중요한 공지는 알림으로 즉시 전달되며, 읽음 여부가 자동 추적됩니다. <span className="text-accent-light font-semibold">작성은 리더·관리자만 가능</span>합니다.
        </p>
      </div>
